...
class KnowledgeNode(Base):
    ...
    presentation_type = Column(String(50), nullable=True, index=True)
    classification_method = Column(String(80), nullable=True)
    classification_confidence = Column(Float, nullable=True)
    classification_status = Column(String(40), nullable=False, default="unclassified", index=True)
