(() => {
  ...
  const labelForType = (type) => ({
    background:'背景故事', rules_detail:'規則細節', examples:'範例', common_mistakes:'常見誤解',
    strategy:'策略', storyteller_advice:'說書人建議', jinx:'相剋規則', player_summary:'玩家摘要',
    interactions:'角色互動', reminders:'提示標記說明', custom_note:'自訂內容', source_excerpt:'來源節錄',
  }[type] || type || '未分類');
