...
const MASTER_ROLE_DB = [
  ...
  {id:"barber",name:"理髮師",team:"outsider",firstNight:0,otherNight:9600,otherNightReminder:"如果理發師今天死亡了，喚醒惡魔並展示“該角色的效果對你生效”信息標記和理發師角色標記。如果惡魔選擇了兩名玩家，將這兩名玩家分別獨自喚醒。對他們展示“你是”信息標記和他們的新角色標記。",image:"https://oss.gstonegames.com/data_file/clocktower/role_icon/barber.png"},
